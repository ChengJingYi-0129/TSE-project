...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT email FROM lecturer WHERE email=:email and Contact_Num=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update lecturer set Pass=:newpassword where email=:email and Contact_Num=:mobile";
